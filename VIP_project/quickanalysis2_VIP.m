function quickanalysis2_VIP(animalNO,sessionID,sessionspec,protocoltag)
...
%         TE = solo2trialevents4_auditory_gonogo([fullpth 'data_@auditory_gonogo_hp_' animalID2 '_' sessionID '.mat']);
%     else
...
%     end
    ...
    for k = 1:length(cellids)
        ...
        viewcell2b(cellids(k),'TriggerName','StimOnset','SortEvent','TrialStart','eventtype','behav','ShowEvents',{{'Stimulus1OffsetTimestamp'}},'Partitions','#ResponseType','window',[-3 3])
        maximize_figure(H)
    ...
    for k = 1:length(cellids)
        H = figure;
        pause(0.01)
        viewcell2b(cellids(k),'TriggerName','Lick','SortEvent','Stimulus1OnsetTimestamp','eventtype','behav','ShowEvents',{{'Stimulus1OffsetTimestamp'}},'Partitions','#ResponseType','window',[-3 3])
%         viewcell2b(cellids(k),'TriggerName','Lick','SortEvent','StimOnset',...
%             'eventtype','behav','ShowEvents',{{'StimOnset' 'Lick'}},...
