...
mx_NT_FA = [fr_FA_tone1(NTactinx1)-baseline1_FA(NTactinx1) fr_FA_tone2(NTactinx2)-baseline2_FA(NTactinx2)];  % max FR after FA, NT cells
mx_NT_Hit = [fr_Hit_tone1(NTactinx1)-baseline1_Hit(NTactinx1) fr_Hit_tone2(NTactinx2)-baseline2_Hit(NTactinx2)];  % max FR after Hit, NT cells
mx_VIP_FA = [fr_FA_tone1(VIPactinx1)-baseline1_FA(VIPactinx1) fr_FA_tone2(VIPactinx2)-baseline2_FA(VIPactinx2)];  % max FR after FA, VIP cells
mx_VIP_Hit = [fr_Hit_tone1(VIPactinx1)-baseline1_Hit(VIPactinx1) fr_Hit_tone2(VIPactinx2)-baseline2_Hit(VIPactinx2)];  % max FR after Hit, VIP cells
...
% Marginal CDFs
edges = -12:2:32;  % histogram bin edges
