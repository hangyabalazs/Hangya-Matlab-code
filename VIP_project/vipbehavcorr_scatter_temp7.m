...
mx_NT_FA = [fr_FA_fb1(NTactinx1)-fr_FA_tone1(NTactinx1) fr_FA_fb2(NTactinx2)-fr_FA_tone2(NTactinx2)];  % max FR after FA, NT cells
mx_NT_Hit = [fr_Hit_fb1(NTactinx1)-fr_Hit_tone1(NTactinx1) fr_Hit_fb2(NTactinx2)-fr_Hit_tone2(NTactinx2)];  % max FR after Hit, NT cells
mx_VIP_FA = [fr_FA_fb1(VIPactinx1)-fr_FA_tone1(VIPactinx1) fr_FA_fb2(VIPactinx2)-fr_FA_tone2(VIPactinx2)];  % max FR after FA, VIP cells
mx_VIP_Hit = [fr_Hit_fb1(VIPactinx1)-fr_Hit_tone1(VIPactinx1) fr_Hit_fb2(VIPactinx2)-fr_Hit_tone2(VIPactinx2)];  % max FR after Hit, VIP cells
