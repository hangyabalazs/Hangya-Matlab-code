function H = vippsth_A1(cellid)
%VIPPSTH_A1   Peri-stimulus time histogram.
%   H = VIPPSTH_A1(CELLID) calculates PSTH aligned to burst first pulses
%   ('BurstOn') for the cell with the specified CellID. It returns the
