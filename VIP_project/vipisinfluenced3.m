...
%VIPISINFLUENCED3   Test for event-locked inhibition and activation.
%   VIPISINFLUENCED3(CELLID) tests whether spike number after an event
...
%
%   VIPISINFLUENCED3 takes a different bin raster (typically aligned to
...
%
%   [B PI MI SI EI PTI TI PA MA SA EA PTA TA H] = VIPISINFLUENCED3(CELLID)
