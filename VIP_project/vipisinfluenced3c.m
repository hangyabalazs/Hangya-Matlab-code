...
%VIPISINFLUENCED3C   Test for event-locked inhibition and activation.
%   VIPISINFLUENCED3C(CELLID) tests whether spike number after an event
%   ('BurstOn') decreases. In VIPISINFLUENCED3C, there's no stimulus-free
...
inx = ~isnan(TE.(EventName2)) & TE.BurstNPulse==1;
valid_trials1 = inx;
valid_trials2 = inx;
