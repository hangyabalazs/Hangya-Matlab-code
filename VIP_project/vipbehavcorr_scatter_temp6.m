...
mx_NT_FA = [log(maxvalue1_FA(NTinx1)./baseline1_FA(NTinx1)) log(maxvalue2_FA(NTinx2)./baseline2_FA(NTinx2))];  % max FR after FA, NT cells
mx_NT_Hit = [log(maxvalue1_Hit(NTinx1)./baseline1_Hit(NTinx1)) log(maxvalue2_Hit(NTinx2)./baseline2_Hit(NTinx2))];  % max FR after Hit, NT cells
mx_VIP_FA = [log(maxvalue1_FA(VIPinx1)./baseline1_FA(VIPinx1)) log(maxvalue2_FA(VIPinx2)./baseline2_FA(VIPinx2))];  % max FR after FA, VIP cells
mx_VIP_Hit = [log(maxvalue1_Hit(VIPinx1)./baseline1_Hit(VIPinx1)) log(maxvalue2_Hit(VIPinx2)./baseline2_Hit(VIPinx2))];  % max FR after Hit, VIP cells
...
% Marginal CDFs
edges = -3:0.05:5;  % histogram bin edges
