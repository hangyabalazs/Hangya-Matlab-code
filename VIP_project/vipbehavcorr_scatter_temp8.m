...
load([DATAPATH 'VIP\FRs\tone_and_fb_rates3.mat'])

% Maximal firing rates
mx_NT_FA = [fr_FA_fb1(NTinx1)-fr_FA_tone1(NTinx1) fr_FA_fb2(NTinx2)-fr_FA_tone2(NTinx2)];  % max FR after FA, NT cells
mx_NT_Hit = [fr_Hit_fb1(NTinx1)-fr_Hit_tone1(NTinx1) fr_Hit_fb2(NTinx2)-fr_Hit_tone2(NTinx2)];  % max FR after Hit, NT cells
mx_VIP_FA = [fr_FA_fb1(VIPinx1)-fr_FA_tone1(VIPinx1) fr_FA_fb2(VIPinx2)-fr_FA_tone2(VIPinx2)];  % max FR after FA, VIP cells
mx_VIP_Hit = [fr_Hit_fb1(VIPinx1)-fr_Hit_tone1(VIPinx1) fr_Hit_fb2(VIPinx2)-fr_Hit_tone2(VIPinx2)];  % max FR after Hit, VIP cells
