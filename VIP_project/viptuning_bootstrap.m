function viptuning_bootstrap
%VIPTUNING_BOOTSTRAP   Spectro-temporal tuning curve.
%   VIPTUNING_BOOTSTRAP calculates average auditory spectro-temporal tuning
...
%
%   VIPTUNING_BOOTSTRAP also calculates and saves a bootstrap sample for
...
% Results directory
global DATAPATH
resdir = [DATAPATH 'VIP\tuning_bootstrap\'];
...
fn = [resdir 'inh_bootstrap.mat'];   % save
...
fn = [resdir 'act_bootstrap.mat'];   % save
save(fn,'fun_nostim_orig','fun_stim_orig','fun_nostim','fun_stim')
