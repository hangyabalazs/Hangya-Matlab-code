function nbpsthsummary_allChAT
...
% Directories
global DATAPATH
resdir = ([DATAPATH 'NB\psthsummary_allChAT_newdata\']);   % result directory
...
red = [216 41 0] / 255;
NumChAT = length(ChATinx) + length(pChATinx);   % number of identified ChAT+ neurons
FA_psth = getvalue('FA_psth',allChAT);    % PSTH aligned to air puff 
FA_psth = cell2mat(FA_psth);
Hit_psth = getvalue('Hit_psth',allChAT);   % PSTH aligned to water delivery
