function nbtuningcurves3_tones(I,issave)
...
global DATAPATH
fs = filesep;
resdir = [DATAPATH 'NB' fs 'tuningnew_' align '_' group  '_' normalization fs];   % results directory
...
[allpsth_orig_hit allspsth_orig_hit allpsth_hit allspsth_hit outcellids_hit] = ...
    poppsth(I,resdir,align,'miss',normalization,doraster,issave); %#ok<*ASGLU>
[allpsth_orig_fa allspsth_orig_fa allpsth_fa allspsth_fa outcellids_fa] = ...
    poppsth(I,resdir,align,'cr',normalization,doraster,issave); %#ok<*ASGLU>
...
for k = 1:NumCell
    ...
    switch align
        case 'tone'
            ...
            missevent = 'StimulusOn'; %#ok<NASGU>
            crevent = 'StimulusOn'; %#ok<NASGU>
            sevent = 'StimulusOff';
        case 'response'
    ...
    missfilter = 'Miss==1'; %#ok<NASGU>
    crfilter = 'CorrectRejection==1'; %#ok<NASGU>
