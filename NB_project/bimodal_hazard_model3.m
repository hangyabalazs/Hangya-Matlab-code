function y = bimodal_hazard_model3(param,x)
...
%   uniform random variable constrained between 0.1 and 15 seconds (mixing
...
%   variability increasing in time with a power law (Phi and Psi, scale and
%   exponent parameter of this increase, respectively).
%
%   Reference:
