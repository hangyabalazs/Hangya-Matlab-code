function error_list = nbresponsesorter_findweakhitresponse(I,issave)
...
global DATAPATH
fs = filesep;
resdir = [DATAPATH 'NB' fs 'responsesorter_n045_121217x_4_6_' fs];   % results directory
...
for k = 1:NumCells
    ...
    try
        ...
        [psth, spsth, ~, ~, spt, stats] = ultimate_psth(cellid,'trial',...
            ...
            'baselinewin',[-1 -0.5],'testwin',[0 0.5],'relative_threshold',0.1);
