...
%   FIXTE updates TrialEvent files for all sessions in CellBase that have
%   cells. Some events were erroneously saved in absolute time stamps as
%   opposed to time stamps relative to 'TrialStart'. These time stamps
%   became meaningless after synchronization (see MAKETRIALEVENTS2_GONOGO).
%   FIXTE corrects these time stamps based on the original, un-synchronized
