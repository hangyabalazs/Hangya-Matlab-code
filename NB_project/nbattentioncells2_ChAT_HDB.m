function nbattentioncells2_ChAT_HDB
%NBATTENTIONCELLS2_CHAT   Attention analysis on cholinergic cells.
%   NBATTENTIONCELLS2_CHAT performs various analyses to asess whether
%   cholinergic cells are related to accuracy, action (animal's response),
%   foreperiod distribution or reaction time. See details about the
%   analyses in REGRESSION_ANALYSIS, NBSTIMRASTER2, NBITIFR and
%   COND_ACCURACY_FR3.
%
...
% Directories
global DATAPATH
resdir = fullfile(DATAPATH,'HDB','attentioncells3_ChAT_newdata',filesep);   % results directory
issave = true;
...
cellids = ChAT;   % identified and putative cholinergic neurons
