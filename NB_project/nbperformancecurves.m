...
global DATAPATH
fs = filesep;
resdir = [DATAPATH 'NB' fs 'performancecurves_new_' align '_' group fs];   % results directory
...
for k = 1:NumCell
    ...
    switch align
        ...
        case 'response'
            ...
            sevent = 'StimulusOn';
        case 'feedback'
            hitevent = findAlignEvent_posfeedback_gonogo(cellid);
            faevent = findAlignEvent_negfeedback_gonogo(cellid);
            sevent = 'StimulusOn';
    end
