function taggingsummary_combined
...
% Directories
global DATAPATH
resdir = [DATAPATH 'NB\taggingsummary_combined\PulseOn\'];
issave = false;

% Cholinergic neurons - HDB
choosecb('HDB')
...
nonChAT = selectcell(['"ChAT+"==0&"Hindex">=0.01&"ID_PC">20&"Lr_PC"<0.15&"validity"==1&' ...
    ...
    'ismember("RatId",[9 12 13])&ismember("session_type",{''feedbackdelay'',''gonogo''})']);  % all NB cells
...
nonChAT = selectcell(['"ChAT+"==0&"Hindex">=0.01&"ID_PC">20&"Lr_PC"<0.15&"validity"==1&' ...
    ...
    'ismember("RatId",[8 12 18 19 20 21])&ismember("session_type",{''feedbackdelay'',''gonogo''})']);  % all NB cells
nonChAT = setdiff(nonChAT,{'n029_120222a_7.1' 'n045_130102a_4.2' 'n046_121229a_1.2' 'n046_130102a_6.3' 'n071_141201a_7.1'});
% the first of the above cells excluded becuase of contamination from a
% light-activated unit; the other 4 because they have <=2 spikes
Hindex3 = getvalue('Hindex',nonChAT);
Hindex4 = getvalue('Hindex',ChAT);
Hindex4(13) = getvalue('Hindex','n046_130108b_4.2');   % use alternative session with better tagging session
Hindex = [Hindex; Hindex3; Hindex4];
figure;
hist(Hindex,150)
