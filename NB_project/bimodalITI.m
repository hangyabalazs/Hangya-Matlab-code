...
% sessions = {'111229a' '120101a' '120103a' ...
%     '120104a' '120105a' '120106a'};
% sessions = {'111229a' '120101a' '120103a' ...
%     '120104a' '120105a' '120106a' '120111a' '120114a'};  % for Merck
% sessions = {'111229a' '111230a' '111231a' '120101a' '120102a' '120103a' ...
%     '120104a' '120105a' '120106a' '120110a' '120111a'};
...
% sessions = {'120117a' '120118a' '120119a' '120120a' '120121a' '120122a'...
%     '120123a' '120124a' '120125a' '120126a'};   % all unimodal
sessions = {'120207a' '120208a' '120209a' '120210a' '120211a'};     % exponential
...
for t = 1:length(cnts)
    for k = 1:numSessions
        ...
        mnsall{t}(mnsall{t}<0.08) = NaN;
        mnsall{t}(mnsall{t}>0.48) = NaN;
    end
...
smns = smooth(mnsmedian,'linear',3);
figure;
plot(cnts,smns)
hold on
[nm xout] = hist(TE.ITIDistribution,50);
