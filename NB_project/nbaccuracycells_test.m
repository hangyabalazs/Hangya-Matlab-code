...
resdir = fullfile(DATAPATH,'NB','accuracycells_newdata','test_all',filesep);   % results directory
issave = true;

% Cells
% nmdir = fullfile(DATAPATH,'NB','accuracycells','good');
nmdir = fullfile(DATAPATH,'NB','accuracycells_newdata','view');
files = dir(nmdir);
