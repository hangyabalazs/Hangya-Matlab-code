function nbattentioncells4
%NBATTENTIONCELLS4   Attention analysis.
%   NBATTENTIONCELLS4 performs various analyses to assess whether cells are
...
% Directories
global DATAPATH
resdir = fullfile(DATAPATH,'NB','attentioncells4_50ms',filesep);   % results directory
issave = true;
