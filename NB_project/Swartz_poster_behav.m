...
PerfGo_nb013 = mean([PerfGo1(1:4); PerfGo2(1:4); PerfGo3(1:4); PerfGo4(1:4); PerfGo5(1:4)]);
PerfGoSE_nb013 = std([PerfGo1(1:4); PerfGo2(1:4); PerfGo3(1:4); PerfGo4(1:4); PerfGo5(1:4)]) / sqrt(5);

PerfNoGo_nb013 = mean([PerfNoGo1(1:4); PerfNoGo2(1:4); PerfNoGo3(1:4); PerfNoGo4(1:4); PerfNoGo5(1:4)]);
PerfNoGoSE_nb013 = std([PerfNoGo1(1:4); PerfNoGo2(1:4); PerfNoGo3(1:4); PerfNoGo4(1:4); PerfNoGo5(1:4)]) / sqrt(5);
...
TimeGo_nb013 = mean([TimeGo1(1:4); TimeGo2(1:4); TimeGo3(1:4); TimeGo4(1:4); TimeGo5(1:4)]);
TimeGoSE_nb013 = std([TimeGo1(1:4); TimeGo2(1:4); TimeGo3(1:4); TimeGo4(1:4); TimeGo5(1:4)]) / 2;

TimeNoGo_nb013 = mean([TimeNoGo1(1:4); TimeNoGo2(1:4); TimeNoGo3(1:4); TimeNoGo4(1:4); TimeNoGo5(1:4)]);
TimeNoGoSE_nb013 = std([TimeNoGo1(1:4); TimeNoGo2(1:4); TimeNoGo3(1:4); TimeNoGo4(1:4); TimeNoGo5(1:4)]) / 2;
