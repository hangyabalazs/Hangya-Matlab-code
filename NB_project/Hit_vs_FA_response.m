...
line([0 0.04],[0 0.04],'Color','k','LineWidth',3)
...
axis([0.2 1 0.2 1])
line([0 1],[0 1],'Color','k','LineWidth',3)

% Statistics
boxstat(Hit_latency(inx),FA_latency(inx),'Hit','FalseAlarm',[],'paired')  % compare latencies
title('Latency')

boxstat(Hit_latency(inx&Hit_latency'<0.05),FA_latency(inx&Hit_latency'<0.05),'Hit','FalseAlarm',[],'paired')  % compare latencies w/o outliers
title('Latency')
