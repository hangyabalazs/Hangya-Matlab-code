function nbaccuracycells_summary2_HDB
...
resdir_all = fullfile(DATAPATH,'HDB','accuracycells_newdata','sign',filesep);
resdir_ChAT = fullfile(DATAPATH,'HDB','accuracycells_newdata','ChAT',filesep);
resdir = fullfile(DATAPATH,'HDB','accuracycells_newdata','summary',filesep);   % results directory
issave = true;

% Selected IDs
% nmdir = fullfile(DATAPATH,'NB','accuracycells','test_all',filesep);
nmdir = fullfile(DATAPATH,'HDB','accuracycells_newdata','test_all',filesep);
files = dir(nmdir);
