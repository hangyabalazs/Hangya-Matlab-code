...
% n018 (ratID==5): 14 NT cells, 0 ChAT, 0 pChAT; ChAT-Cre aguti
...
% n029 (ratID==12): 190 NT cells, 4 ChAT, 9 pChAT; ChAT-Cre bl6
% n037 (ratID==13): 72 NT cells, 0 ChAT, 1 pChAT; ChAT-Cre bl6?
% n038 (ratID==14): 4 NT cells, 0 ChAT, 0 pChAT; ChAT-Cre bl6? - 3 sessions
% n039 (ratID==15): 49 NT cells, 0 ChAT, 0 pChAT; ChAT-Cre bl6?
% n040 (ratID==16): 29 NT cells, 0 ChAT, 0 pChAT; PV-Cre bl6
% n043 (ratID==17): 13 NT cells, 0 ChAT, 0 pChAT; ChAT-ChR2 bl6 - 2 sessions
% n045 (ratID==18): 67 NT cells, 1 ChAT, 1 pChAT; ChAT-ChR2 bl6
% n046 (ratID==19): 210 NT cells, 9 ChAT, 7 pChAT; ChAT-ChR2 bl6
% n071 (ratID==20): 201 NT cells, 5 ChAT, 0 pChAT; ChAT-Cre aguti
% n072 (ratID==21): 21 NT cells, 2 ChAT, 0 pChAT; ChAT-Cre aguti - 2 sessions
% n077 (ratID==26): 9 NT cells, 0 ChAT, 1 pChAT; ChAT-Cre aguti - 2 sessions

% HDB
% n067 (ratID==3): 136 NT cells, 7 ChAT, 7 pChAT; ChAT-Cre aguti
% n070 (ratID==5): 61 NT cells, 3 ChAT, 0 pChAT; ChAT-Cre aguti
% n078 (ratID==6): 11 NT cells, 2 ChAT, 0 pChAT; ChAT-Cre aguti - 4 sessions
...
% n071 (ratID==20): 5-days pre-training
% n072 (ratID==21): 4-days pre-training
% n072 (ratID==26): 4-days pre-training

% HDB
% n067 (ratID==3): 5-days pre-training
% n070 (ratID==5): 3-days pre-training
% n078 (ratID==6): 6-days pre-training
pretraining = [2 6 2 7 6 3 3 2 1 3 4 5 4 4 4 3 5 4 4 5 3 6];
...
% n071 (ratID==20): above chance by 1st day of full task
% n072 (ratID==21): above chance by 1st day of full task
% n077 (ratID==26): above chance by 1st day of full task
% HDB
% n067 (ratID==3): above chance by 1st day of full task
% n070 (ratID==5): above chance by 1st day of full task
% n078 (ratID==6): above chance by 3rd day of full task
...
% n071 (ratID==20): full psychometric from 8th day of full task
% n072 (ratID==21): full psychometric from 6th day of full task
% n077 (ratID==26): full psychometric from 5th day of full task
% HDB
% n067 (ratID==3): full psychometric from 5th day of full task
% n070 (ratID==5): full psychometric from 6th day of full task
% n078 (ratID==6): full psychometric from 8th day of full task
fullpsy = [NaN 9 14 9 13 7 10 7 7 10 8 17 8 8 8 10 8 6 5 5 6 8];
...
% n071 (ratID==20): max noise 40
% n072 (ratID==21): max noise 35
% n077 (ratID==26): max noise 35
% HDB
% n067 (ratID==3): max noise 45
% n070 (ratID==5): max noise 30
% n078 (ratID==6): max noise 30
maxnoise = [60 60 30 45 20 30 50 50 50 45 45 25 45 45 45 45 40 35 35 45 30 30];
...
NT = selectcell(['"ChAT+"==0&"ID_PC">20&"Lr_PC"<0.15&"validity"==1&' ...
    'ismember("session_type",{''gonogo'',''feedbackdelay''})&' ...
    'ismember("Area1",{''HDB'',''SI'',''VP''})']);  % NT (n = 208)

%%

mice = unique(listtag('RatID'));
for k = 1:6
    tmp = findcell('rat',mice{k});
    nms = cellfun(@(s)s(1:4),tmp,'uniformoutput',false);
    mc = unique(nms);
    lNT = length(intersect(NT,tmp));
    lChAT = length(intersect(ChAT,tmp));
