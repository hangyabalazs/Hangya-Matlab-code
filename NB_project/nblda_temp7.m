...
% Load data
global DATAPATH
load([DATAPATH 'NB\responsesorter_new3\allPSTH.mat'])
...
NTcorr = tcorr(allpsth,template);   % correlation with mean PV PSTH
...
figure   % plot
plot(PC1(celltypes{3}),u4(celltypes{3}),'o','MarkerSize',5,'Color',[0.8 0.8 0.8],'MarkerFaceColor',[0.8 0.8 0.8]);
hold on
plot(PC1(celltypes{1}),u4(celltypes{1}),'o','MarkerSize',12,'MarkerFaceColor',[0 0.8 0],'MarkerEdgeColor',[0 0.8 0]);
plot(PC1(celltypes{2}),u4(celltypes{2}),'o','MarkerSize',5,'MarkerFaceColor',[0.7 0.7 0.7],'MarkerEdgeColor',[0.7 0.7 0.7]);
