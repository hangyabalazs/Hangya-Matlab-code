function nbattentioncells2
%NBATTENTIONCELLS2   Attention analysis.
%   NBATTENTIONCELLS2 performs various analyses to asess whether cells are
...
% Directories
global DATAPATH
resdir = fullfile(DATAPATH,'NB','attentioncells3',filesep);   % results directory
issave = true;
