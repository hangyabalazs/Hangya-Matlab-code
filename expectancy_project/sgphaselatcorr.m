function sgphaselatcorr
%SGPHASELATCORR   Correlation between delta phase and P300 latency.
%   SGPHASELATCORR calculates linear-circular correlation between 0 ms
...
resdir = [DATAPATH 'Expectancy\phaselat3\'];
mm = pwd;
cd(resdir)
...
deltaphase = cell(1,13);    % extract delta phase and lat.
lat = cell(1,13);
