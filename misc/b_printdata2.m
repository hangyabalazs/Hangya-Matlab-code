function b_printdata2(list_theta,list_noth)
...
%   segment.
%
%   PRINTDATA2 prints pseudounit instead of raw unit.
%
%   See also ENTRYRUN3.
...
% Plot
    ...
    plot(time,unit_new)
    y_lim = ylim;
    line([seglen_theta seglen_theta],[y_lim(1)-0.5 y_lim(2)+0.5],'Color','green');
    axis([time(1) time(end) y_lim(1)-0.5 y_lim(2)+0.5])
    S3 = subplot(3,1,3);
    cd(entrydir)
