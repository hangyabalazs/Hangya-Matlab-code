function [C Cb Cc trsr] = czplacefigs2(int,pyr,exp,type)
%CZPLACEFIGS2   Prepare figures for publication.
%   CZPLACEFIGS2 generates smoothed rate maps (5 x 5 pixel Gaussian kernel,
...
%
%   Syntax:
%   [C CB CC TRSR] = CZPLACEFIGS2(INT,PYR,EXP,TYPE)
%
%   Input arguments:
