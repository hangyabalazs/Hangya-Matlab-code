function czplaceanalysis2b(fname)
%CZPLACEANALYSIS2B   Analysis of spatial firing.
%   CZPLACEANALYSIS2B seeks for the sign of inhibition on the crosscorrelograms:
...
for x = 1:np
    for y = x+1:np
        ...
        save(['inhib_' num2str(x) '_' num2str(y)],'h','p','ccr')
...
%         py = linspace(fminy,fmaxy,size(pirhst,1));
%         pcolor(px,py,pirhst)
%         A1 = gca;
%         shading flat
%         hold on
