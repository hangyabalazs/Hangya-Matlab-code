function czthetaselectorrun2(inpdir,resdir)
...
% Saving
    ...
    cd jpg
    eval(['saveas(H,''THETA_SELECT_',filenam(1:3),'_',filenam(5:6),'.jpg'')']);
    cd ..
    cd matrix
    eval(['save(''THETA_SELECT_',filenam(1:3),'_',filenam(5:6),'.mat'',''Out'')']);
    cd ..
    clear pow
