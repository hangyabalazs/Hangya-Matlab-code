function czplacefigs
%CZPLACEFIGS   Prepare figures for publication.
%   CZPLACEFIGS generates smoothed rate maps (5 x 5 pixel Gaussian kernel,
...
[C Cb] = czcmpl2(ms3_int,ms3_pyr,c);
