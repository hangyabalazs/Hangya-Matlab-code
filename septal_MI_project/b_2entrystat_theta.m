function [ThetaNoburst,ThetaBurst,TN,TB] = b_2entrystat_theta
%2ENTRYSTAT_THETA   Calculates statistics for entropy data (theta segments).
%   2ENTRYSTAT_THETA runs on the output of ENTRYRUN_THETA or ENTRYRUN3. Edit
...
%
%   See also 2ENTRYSTAT_NOTH and ENTRYSTAT2_THETA.
...
fn = [DATAPATH 'Entry3_cont2\Stat\DTF_onesec\theta_rorc.xls'];
fnm = [DATAPATH 'Entry3_cont2\Stat\DTF_onesec\stat_theta_rorc.mat'];
