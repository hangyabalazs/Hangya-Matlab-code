function [Theta,T] = b_2entry3chstat2_theta
%2ENTRY3CHSTAT2_THETA   Calculates statistics for entropy data (theta segments).
%   2ENTRY3CHSTAT2_THETA runs on the output of ENTRYRUN_3CH. Edit code to
...
%
%   See also 2ENTRY3CHSTAT2_NOTH and ENTRYSTAT2_THETA.
...
fn = [DATAPATH 'Entry3c_cont3_unitunit\Stat\phase\theta_rorc.xls'];
fnm = [DATAPATH 'Entry3c_cont3_unitunit\Stat\phase\stat_theta_rorc.mat'];
