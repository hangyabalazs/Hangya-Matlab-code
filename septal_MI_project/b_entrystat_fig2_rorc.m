function [Stats, ST] = b_entrystat_fig2_rorc
%ENTRYSTAT_FIG2_RORC   Calculates statistics for entropy data.
%   ENTRYSTAT_FIG2_RORC runs on the output of ENTRYRUN_THETA or ENTRYRUN3. 
...
for o = 1:sf
    ...
    ST{end+1,1} = mEeur_theta-mEeur_theta_ctrl;
    ST{end,2} = mEeur_noth-mEeur_noth_ctrl;
    ST{end,3} = mEuer_theta-mEuer_theta_ctrl;
    ST{end,4} = mEuer_noth-mEuer_noth_ctrl;
    STname{end+1} = files_short{o};
end

% Save
str = [{'eu theta - eu theta ctrl'} {'eu noth - eu noth ctrl'}...
    {'ue theta - ue theta ctrl'} {'ue noth - ue noth ctrl'}];
