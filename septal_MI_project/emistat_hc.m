function [Stats_eu, Stats_ue, STeu, STue] = emistat_hc
%EMISTAT_HC   Calculates statistics for mutual information data.
%   EMISTAT_HC runs on the output of ENTRYRUN3C. Edit code to specify exact 
%   directories!
%
