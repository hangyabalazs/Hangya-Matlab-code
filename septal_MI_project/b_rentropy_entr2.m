function b_rentropy_entr2
%RENTROPY_ENTR2   Entropy calculation.
%   RENTROPY_ENTR2 calculates entropies for 5 sec. data segments (80% overlaping windows). 
%   The concidered distributions are interspike interval distribution and eeg amplitude 
...
%
%   See also ENTROPY, RENTROPY and RENTROPY_ENTROPY.
...
wh_to = [DATAPATH 'Rentropy\raw_entr2\real\'];
files = dir(wh_from);
files = files(3:end);
...
% Progress indicator
wb = waitbar(0,'Running RENTROPY ENTR2...','Position',[360 250 275 50]);    %Progress indicator
global WB
WB(end+1) = wb;
