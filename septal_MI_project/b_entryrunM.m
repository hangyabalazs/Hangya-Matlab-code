function b_entryrunM
%ENTRYRUNM   Runs entropy and PDC on a sequence of recordings.
%   ENTRYRUNM calculates wavelet power and wavelet phase entropy for theta
%   segments using 1000-point non-overlapping and 50% overlapping time
...
%
%   ENTRYRUNM attaches theta and non-theta segment together and completes
...
resdir = [DATAPATH 'Entry3b_M\Theta\'];
datadir = DATADIR2;
...
% Progress indicator
wb = waitbar(0,'Running ENTRYRUNM...','Position',[360 250 275 50]);
global WB
WB(end+1) = wb;
