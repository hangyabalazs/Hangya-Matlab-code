function b_entryrun3c_cont3
%ENTRYRUN3C_CONT3   Runs entropy and PDC on a sequence of recordings.
%   ENTRYRUN3C_CONT3 calculates wavelet power and wavelet phase entropy for 
...
%
%   ENTRYRUN3C_CONT3 attaches theta and non-theta segment together and 
...
%
%   See also DTF, 2DTF, ENTRY, ENTRYRUN_THETA, ENTRYRUN_NOTH and ENTRYRUN3.
...
global DATADIR
global DATADIR2
inpdir1 = [DATAPATH 'Burst\Cluster\Theta_hc\'];   % input directory
inpdir2 = [DATAPATH 'Burst\Cluster\Noth_hc\'];   % input directory
resdir = [DATAPATH 'Entry3c_cont3\Theta_hc\'];
...
% Progress indicator
wb = waitbar(0,'Running ENTRYRUN3C CONT3...','Position',[360 250 275 50]);
global WB
WB(end+1) = wb;
