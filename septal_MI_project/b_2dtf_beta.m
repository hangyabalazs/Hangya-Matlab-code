function b_2dtf_beta
%2DTF_BETA   Partial Directed Coherence and Directed Transfer Function.
%   2DTF_BETA calculates and plots bivariate PDC and DTF for EEG
%   data files. It calls IN3 for import.
%   Default settings: 
%       segmnent length (seglen): 20000 data points
%       number of frequencies (N): 512
%       sampling rate: 10000 Hz (after downsampling (FS): 1000 Hz).
%
%   EEG is downsampled on 1000 Hz, then maximal value is normalized to one.
%
...
for i = 1:maxi
    ...
    PDC(:,:,:,i) = dircoh(eeg2,unit2);  % partial directed coherence
