function b_entrylongstat3
%ENTRYLONGSTAT3   Calculates statistics for whole registration uncert. coeff.
...
% Progress indicator
wb = waitbar(0,'Running ENTRYLONGSTAT3...','Position',[360 250 315 50]);    %Progress indicator
global WB
WB(end+1) = wb;
