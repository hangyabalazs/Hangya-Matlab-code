function [Noth,N] = b_2entry3chstat3_noth
%2ENTRY3CHSTAT3_NOTH   Calculates statistics for entropy data (noth segments).
%   2ENTRY3CHSTAT3_NOTH runs on the output of ENTRYRUN_3CH. Edit code to
...
%
%   See also 2ENTRY3CHSTAT3_THETA and ENTRYSTAT3_NOTH.
...
fn = [DATAPATH '2Entry_uu_stand\Stat\DTF_onesec\2noth.xls'];
fnm = [DATAPATH '2Entry_uu_stand\Stat\DTF_onesec\stat_2noth.mat'];
