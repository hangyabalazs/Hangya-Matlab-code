function b_entryrun3b_inv
%ENTRYRUN3B_INV   Runs entropy and PDC on a sequence of recordings.
%   ENTRYRUN3B_INV calculates wavelet power and wavelet phase entropy for theta
...
%
%   ENTRYRUN3B_INV attaches non-theta and theta segment together and completes
%   the calculation on the attached segments. (Note that the difference
%   between ENTRYRUN_3B and ENTRYRUN_3B_INV is the order of theta and
%   non-theta segment.)
%
...
resdir = [DATAPATH 'Entry3b_inv\Theta\'];
datadir = DATADIR2;
...
% Progress indicator
wb = waitbar(0,'Running ENTRYRUN3B INV...','Position',[360 250 275 50]);
global WB
WB(end+1) = wb;
