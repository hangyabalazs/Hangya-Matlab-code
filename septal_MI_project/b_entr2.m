function [hx,hy,jh,Hx,Hy,Hxy,Hxcy,Hycx,Ixy,Uxy,Uyx] = b_entr2(tfv1,tfv2,y1,h1,y2,h2)
%ENTR2   Wavelet entropy calculation.
%   [hx,hy,jh,Hx,Hy,Hxy,Hxcy,Hycx,Ixy,Uxy,Uyx] = ENTR2(tfv1,tfv2,y1,h1,y2,h2) needs six
%   inputs:
