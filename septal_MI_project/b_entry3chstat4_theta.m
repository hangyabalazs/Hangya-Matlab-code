function [Theta,T] = b_entry3chstat4_theta
%ENTRY3CHSTAT4_THETA   Calculates statistics for entropy data (theta segments).
%   ENTRY3CHSTAT4_THETA runs on the output of ENTRYRUN_3CH. Edit code to
...
%
%   See also ENTRY3CHSTAT4_NOTH and ENTRYSTAT4_THETA.
...
fn = [DATAPATH 'Entry_unitunit\Stat\ENTROPY_power_ol1\2theta.xls'];
fnm = [DATAPATH 'Entry_unitunit\Stat\ENTROPY_power_ol1\stat_2theta.mat'];
