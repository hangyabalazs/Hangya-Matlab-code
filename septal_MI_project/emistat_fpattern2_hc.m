function [Stats_eu, Stats_ue, STeu, STue] = emistat_fpattern2_hc
%EMISTAT_FPATTERN2_HC   Calculates statistics for mutual information data.
%   EMISTAT_FPATTERN2_HC runs on the output of ENTRYRUN3C. Edit code to
