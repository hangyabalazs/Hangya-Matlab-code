function [Stats_eu, Stats_ue, STeu, STue] = emistat_fpattern
%EMISTAT_FPATTERN   Calculates statistics for mutual information data.
%   EMISTAT_FPATTERN runs on the output of ENTRYRUN3C. Edit code to specify
%   exact directories!
%
