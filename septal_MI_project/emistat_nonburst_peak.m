function [Stats_eu, Stats_ue, STeu, STue] = emistat_nonburst_peak
%EMISTAT_NONBURST_PEAK   Calculates statistics for mutual information data.
%   EMISTAT_NONBURST_PEAK runs on the output of ENTRYRUN3C. Edit code to
...
%   Mann-Whitney U-test.
%
%   EMISTATNON_NONBURST_PEAK restricts the comparison to peak MI values of
%   non-bursting cells with MI values significantly higher than control.
%
%   See also EMISTAT_NONBURST and ENTRYSTAT6.
...
% Save
cd(resdir)
saveas(H,'MIbox_nonburst_peak')
save('MIstat_nonburst_peak','MI_theta')
cd(mm)
