function b_6kwentropy_control3
%6KWENTROPY_CONTROL3   Wavelet entropy calculation.
%   6KWENTROPY_CONTROL3 calculates wavelet magnitude entropies for 2MEGAWAVERUN_ENTRCTRL output
%   files. It calls ENTR2 for the raw entropy calculation. 6KWENTROPY_CONTROL3 computes entropy
...
wh_to = [DATAPATH 'Entropy6\control\random_unit\'];
files = dir(wh_from);
files = files(3:end);
...
% Progress indicator
wb = waitbar(0,'Running 6KWENTROPY CONTROL3...','Position',[360 250 275 50]);    %Progress indicator
global WB
WB(end+1) = wb;
