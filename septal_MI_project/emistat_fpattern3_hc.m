function [Stats_eu, Stats_ue, STeu, STue] = emistat_fpattern3_hc
%EMISTAT_FPATTERN3_HC   Calculates statistics for mutual information data.
%   EMISTAT_FPATTERN3_HC runs on the output of ENTRYRUN3C. Edit code to
