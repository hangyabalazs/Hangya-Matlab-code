function [hx,hy,jh,Hx,Hy,Hxy,Hxcy,Hycx,Ixy,Uxy,Uyx] = b_entry_sub(tfv1,tfv2,y1,h1,y2,h2)
%ENTRY_SUB   Wavelet entropy calculation.
%   [hx,hy,jh,Hx,Hy,Hxy,Hxcy,Hycx,Ixy,Uxy,Uyx] = ENTRY_SUB(tfv1,tfv2,y1,h1,y2,h2) needs six
%   inputs:
