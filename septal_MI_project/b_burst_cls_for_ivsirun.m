function [burstloc,bursting,H] = b_burst_cls_for_ivsirun(wts)
%BURST_CLS_FOR_IVSIRUN Version of BURST_CLS used by IVSIRUN.
%   BURST_CLS_FOR_IVSI has three output arguments: first contains the localization of the first spikes
%   of bursts, second is bursting (1, if there are bursts, 0 otherwise), third is the handle of "bursts
%   plot."
%   The input argument hides the decision whether you wish to save the number of clusters.
%
%   See also BURST_CLS, BURST_CLS_AUTO, IVSI and IVSIRUN.
...
if wts == [];
    ...
    filename2 = [DATAPATH,'clusters\',fname(1:6),'_',num2str(datinx1/10000),'_',num2str(datinx2/10000),'_clus.txt'];
