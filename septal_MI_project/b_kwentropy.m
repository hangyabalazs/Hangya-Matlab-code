function b_kwentropy
%KWENTROPY   Wavelet entropy calculation.
%   KWENTROPY calculates wavelet magnitude entropies for MEGAWAVERUN2 output files. It calls ENTR2
%   for the raw entropy calculation. Outputs:
...
%
%   See also ENTR2 and MEGAWAVERUN2.
...
wh_to = [DATAPATH 'Entropy\entropy_20__5000\temp2\'];
files = dir(wh_from);
files = files(3:end);
...
% Progress indicator
wb = waitbar(0,'Running KWENTROPY...','Position',[360 250 275 50]);    %Progress indicator
global WB
WB(end+1) = wb;
