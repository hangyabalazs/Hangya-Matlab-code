function b_entryrun_theta
%ENTRYRUN_THETA   Runs entropy and PDC on a sequence of theta segments.
%   ENTRYRUN_THETA calculates wavelet power and wavelet phase entropy for
...
%
%   See also DTF, 2DTF, ENTRY, ENTRYRUN3 and ENTRYRUN_NOTH.
