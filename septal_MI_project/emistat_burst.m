function [Stats_eu, Stats_ue, STeu, STue] = emistat_burst
%EMISTAT_BURST   Calculates statistics for mutual information data.
%   EMISTAT_BURST runs on the output of ENTRYRUN3C. Edit code to specify
%   exact directories!
%
...
%   Mann-Whitney U-test.
%
%   EMISTAT_BURST restricts the comparison to theta-bursting cells with
...
% Save
cd(resdir)
saveas(H,'MIbox_burst_cont3')
save('MIstat_burst_cont3','MI_theta')
cd(mm)
