function b_entryrun3c_inv_cont2
%ENTRYRUN3C_INV_CONT2   Runs entropy and PDC on a sequence of recordings.
%   ENTRYRUN3C_INV_CONT2 calculates wavelet power and wavelet phase entropy
...
%
%   ENTRYRUN3C_INV_CONT2 attaches non-theta and theta segment together and
%   completes the calculation on the attached segments. (Note that the
%   difference between ENTRYRUN3C and ENTRYRUN3C_INV is the order of
...
resdir = [DATAPATH 'Entry3c_inv_cont2\Theta\'];
datadir = DATADIR2;
...
% Progress indicator
wb = waitbar(0,'Running ENTRYRUN3C INV CONT2...','Position',[360 250 275 50]);
global WB
WB(end+1) = wb;
