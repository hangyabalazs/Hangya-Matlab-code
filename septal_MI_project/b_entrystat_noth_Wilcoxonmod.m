function [NothNoburst,NothBurst,NN,NB] = b_entrystat_noth_Wilcoxonmod
%ENTRYSTAT_NOTH_WILCOXONMOD   Calculates statistics for entropy data (non-theta segments).
%   ENTRYSTAT_NOTH_WILCOXONMOD runs on the output of ENTRYRUN_THETA or
...
%
%   See also ENTRYSTAT_THETA_WILCOXONMOD.
