function b_entryrun_noth2
%ENTRYRUN_NOTH2   Runs entropy and PDC on a sequence of non-theta segments.
%   ENTRYRUN_NOTH2 calculates wavelet power and wavelet phase entropy for
...
%
%   See also DTF, 2DTF, ENTRY, ENTRYRUN3 and ENTRYRUN_THETA2.
...
% Progress indicator
wb = waitbar(0,'Running ENTRYRUN NOTH2...','Position',[360 250 275 50]);
global WB
WB(end+1) = wb;
