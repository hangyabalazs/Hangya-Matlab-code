function b_entrylongstat2
%ENTRYLONGSTAT2   Calculates statistics for whole registration uncert. coeff.
%   ENTRYLONGSTAT2 calculates and saves t-test, Wilcoxon signrank-test and
...
%
%   Unlike ENTRYLONGSTAT, ENTRYLONGSTAT2 analyses segments with at least
%   100 spikes.
%
...
% Progress indicator
wb = waitbar(0,'Running ENTRYLONGSTAT2...','Position',[360 250 315 50]);    %Progress indicator
global WB
WB(end+1) = wb;
