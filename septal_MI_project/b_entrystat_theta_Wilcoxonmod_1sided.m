function [ThetaNoburst,ThetaBurst,TN,TB] = b_entrystat_theta_Wilcoxonmod_1sided
%ENTRYSTAT_THETA_WILCOXONMOD_1SIDED   Calculates statistics for entropy data (theta segments).
%   ENTRYSTAT_THETA_WILCOXONMOD_1SIDED runs on the output of ENTRYRUN_THETA
...
%
%   See also ENTRYSTAT_NOTH_WILCOXONMOD_1SIDED.
...
% Save
fn = [DATAPATH 'Entry\Stat\theta_Wilcoxonmod_1sided.xls'];
