function [NothNoburst,NothBurst,NN,NB] = b_entrystat_noth
%ENTRYSTAT_NOTH   Calculates statistics for entropy data (non-theta segments).
%   ENTRYSTAT_NOTH runs on the output of ENTRYRUN_NOTH or ENTRYRUN3. Edit
...
%
%   See also ENTRYSTAT_THETA and ENTRYSTAT2_NOTH.
...
fn = [DATAPATH 'Entry_cont2\Stat\DTF_halfsec\noth_rorc.xls'];
fnm = [DATAPATH 'Entry_cont2\Stat\DTF_halfsec\stat_noth_rorc.mat'];
