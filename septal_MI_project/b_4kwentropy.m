function b_4kwentropy
%4KWENTROPY   Wavelet entropy calculation.
%   4KWENTROPY calculates wavelet magnitude entropies for MEGAWAVERUN_ENTRCTRL2 output files. 
%   It calls ENTR3 for the raw entropy calculation. It computes entropy for the theta band
%   only and normalizes for the whole theta band. It uses 5 sec. long, 80 % overlaping windows.
%   Being a forth generation entropy function, it uses the same bins for EEG and unit wavelet.
%   Outputs:
...
%
%   See also ENTR3 and MEGAWAVERUN_ENTRCTRL2.
...
% Progress indicator
wb = waitbar(0,'Running 4KWENTROPY...','Position',[360 250 275 50]);    %Progress indicator
global WB
WB(end+1) = wb;
