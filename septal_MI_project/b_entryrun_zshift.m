function b_entryrun_zshift
%ENTRYRUN_ZSHIFT   Runs entropy and PDC on a sequence of theta segments.
%   ENTRYRUN_ZSHIFT calculates wavelet power and wavelet phase entropy for
...
%
%   ENTRYRUN_ZSHIFT shifts unit with the loaded zshift values - see ZSHIFT2
%   and ZSHIFTRUN3 for details.
%
%   See also DTF, 2DTF, ENTRY, ENTRYRUN2_THETA, ZSHIFT2 and ZSHIFTRUN3.
...
resdir = [DATAPATH 'Entry_zshift2\Theta\'];
datadir = DATADIR2;
...
% Progress indicator
wb = waitbar(0,'Running ENTRYRUN ZSHIFT...','Position',[360 250 275 50]);
global WB
WB(end+1) = wb;
