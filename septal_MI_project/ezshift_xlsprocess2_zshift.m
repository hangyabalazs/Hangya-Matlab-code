function ezshift_xlsprocess2_zshift
%EZSHIFT_XLSPROCESS2_ZSHIFT    Generates plots from ZSHIFT output excel file.
%   EZSHIFT_XLSPROCESS2_ZSHIFT works on the output excel file of EZSHIFTRUN.
%   It compares shift values between cells with different MI values.
%
%   See also EZSHIFTRUN, EZSHIFT_XLSPROCESS2 and ENTRYRUN3C_ZSHIFT.
...
saveas(H1,'zshift_maxz_MI.fig')

H2 = mibox(MIp(~isnan(MIp)),MIn(~isnan(MIn)),'MI sig.','MI non-sig.');
saveas(H2,'zshift_maxz_MIbox.fig')
