function [NothNoburst,NothBurst,NN,NB] = b_2entrystat3_noth
%2ENTRYSTAT3_NOTH   Calculates statistics for entropy data (non-theta segments).
%   2ENTRYSTAT3_NOTH runs on the output of ENTRYRUN_THETA or ENTRYRUN3. Edit
...
fn = [DATAPATH 'Entry3_cont2\Stat\DTF_onesec\2noth.xls'];
fnm = [DATAPATH 'Entry3_cont2\Stat\DTF_onesec\stat_2noth.mat'];
