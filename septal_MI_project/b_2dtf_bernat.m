...
%   2DTF calculates bivariate PDC and DTF for septo-hippocampal data files.
%   It calls IN3 for import and DISC for unit discrimination.
%   Default settings: 
...
%
%   Output: Integrals for PDC in theta band (3-6 Hz) in the function of time
%               ('LIN'). unit->eeg: red; eeg->unit: blue. Value missing in
%               case of no spike during a 2 sec segment.
%
