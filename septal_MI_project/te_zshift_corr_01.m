...
for o = 1:sf
    ...
    mNTEeu = median(NTE_theta_eu(1:4));
    mNTEue = median(NTE_theta_ue(1:4));
    if mNTEeu > 1 | mNTEue > 1
        continue
    end
...
% Save
cd(resdir)
saveas(H1,'zshift_vs_DF_PV_01')
saveas(H2,'zshift_vs_DF_HCN_01')
cd(mm)
