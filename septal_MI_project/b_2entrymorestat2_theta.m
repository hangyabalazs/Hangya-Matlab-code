function [ThetaNoburst,ThetaBurst,TN,TB] = b_2entrymorestat2_theta
%2ENTRYMORESTAT2_THETA   Calculates statistics for entropy data (theta segments).
%   2ENTRYMORESTAT2_THETA runs on the output of ENTRYRUN_THETA or ENTRYRUN3C. Edit
...
fn = [DATAPATH 'Entry3c\Stat\power\theta_entropy_rorc.xls'];
fnm = [DATAPATH 'Entry3c\Stat\power\stat_theta_entropy_rorc.mat'];
