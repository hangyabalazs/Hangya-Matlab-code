function [Noth,N] = b_entry3chstat2_noth
%ENTRY3CHSTAT2_NOTH   Calculates statistics for entropy data (non-theta segments).
%   ENTRY3CHSTAT2_NOTH runs on the output of ENTRYRUN_3CH. Edit code to
...
%
%   See also ENTRY3CHSTAT2_THETA and ENTRYSTAT2_NOTH.
...
fn = [DATAPATH 'Entry2_unitunit\Stat\ENTROPY_phase_ol1\noth_rorc.xls'];
fnm = [DATAPATH 'Entry2_unitunit\Stat\ENTROPY_phase_ol1\stat_noth_rorc.mat'];
