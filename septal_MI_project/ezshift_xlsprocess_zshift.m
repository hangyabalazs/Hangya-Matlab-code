function ezshift_xlsprocess_zshift
%EZSHIFT_XLSPROCESS_ZSHIFT    Generates plots from ZSHIFT output excel file.
%   EZSHIFT_XLSPROCESS_ZSHIFT works on the output excel file of EZSHIFTRUN.
%   It compares shift values between cells with different MI values.
%
%   See also EZSHIFTRUN, EZSHIFT_XLSPROCESS and ENTRYRUN3C_ZSHIFT.
...
saveas(H1,'zshift_maxlen_MI.fig')

H2 = mibox(MIp(~isnan(MIp)),MIn(~isnan(MIn)),'MI sig.','MI non-sig.');
saveas(H2,'zshift_maxlen_MIbox.fig')
