function b_entryrun4
%ENTRYRUN4   Runs entropy and PDC on a sequence of recordings.
%   ENTRYRUN4 calculates wavelet power and wavelet phase entropy for theta
...
%
%   ENTRYRUN4 runs on all theta and non-theta segments.
%
