function [Stats_eu, Stats_ue, STeu, STue] = emistat_segments2
%EMISTAT_SEGMENTS2   Calculates statistics for mutual information data.
%   EMISTAT_SEGMENTS2 runs on the output of ENTRYRUN3C. Edit code to specify
%   exact directories!
%
...
%
%   EMISTAT_SEGMENTS2 includes files with MI not significantly greater than
%   control.
%
...
% Boxplot
cd(resdir)
H = mibox([MI_theta.PVp MI_theta.PVn MI_theta.HCNp MI_theta.HCNn MI_theta.na]...
    ,[MI_noth.PVp MI_noth.PVn MI_noth.HCNp MI_noth.HCNn MI_noth.na],'theta','noth');
saveas(H,'MIsegments2')
cd(mm)
