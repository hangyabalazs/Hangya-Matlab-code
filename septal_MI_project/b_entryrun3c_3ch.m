function b_entryrun3_3ch2
%ENTRYRUN_3CH2   Runs entropy and PDC on a sequence of theta segments.
%   ENTRYRUN_3CH2 calculates wavelet power and wavelet phase entropy for
...
%
%   ENTRYRUN_3CH2 attaches theta and non-theta segment together and completes
...
resdir = [DATAPATH 'Entry3c_unitunit\Theta\'];
...
% Progress indicator
wb = waitbar(0,'Running ENTRYRUN3C 3CH...','Position',[360 250 275 50]);
global WB
WB(end+1) = wb;
