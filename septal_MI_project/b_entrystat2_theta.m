function [ThetaNoburst,ThetaBurst,TN,TB] = b_entrystat2_theta
%ENTRYSTAT2_THETA   Calculates statistics for entropy data (theta segments).
%   ENTRYSTAT2_THETA runs on the output of ENTRYRUN_THETA or ENTRYRUN3. Edit
...
%
%   See also ENTRYSTAT2_NOTH and ENTRYSTAT_THETA.
...
fn = [DATAPATH 'Entry2_3ch\Stat\ENTROPY_phase_ol1\theta_rorc.xls'];
fnm = [DATAPATH 'Entry2_3ch\Stat\ENTROPY_phase_ol1\stat_theta_rorc.mat'];
