function [Stats_eu, Stats_ue, STeu, STue] = emistat_burst_peak
%EMISTAT_BURST_PEAK   Calculates statistics for mutual information data.
%   EMISTAT_BURST_PEAK runs on the output of ENTRYRUN3C. Edit code to
...
%   Mann-Whitney U-test.
%
%   EMISTAT_BURST_PEAK restricts the comparison to peak MI values of
%   theta-bursting cells with MI values significantly higher than control.
%
%   See also EMISTAT_BURST and ENTRYSTAT6.
...
% Save
cd(resdir)
saveas(H,'MIbox_burst_peak')
save('MIstat_burst_peak','MI_theta')
cd(mm)
