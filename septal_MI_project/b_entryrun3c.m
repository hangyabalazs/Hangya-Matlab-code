function b_entryrun3c
%ENTRYRUN3C   Runs entropy and PDC on a sequence of recordings.
%   ENTRYRUN3C calculates wavelet power and wavelet phase entropy for theta
...
%
%   ENTRYRUN3C attaches theta and non-theta segment together and completes
...
resdir = [DATAPATH 'Entry3c\Transfer2\'];
datadir = [DATADIR 'discriminated\'];
...
% Progress indicator
wb = waitbar(0,'Running ENTRYRUN3C...','Position',[360 250 275 50]);
global WB
WB(end+1) = wb;
