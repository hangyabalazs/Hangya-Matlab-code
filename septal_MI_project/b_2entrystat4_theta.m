function [ThetaNoburst,ThetaBurst,TN,TB] = b_2entrystat4_theta
%2ENTRYSTAT4_THETA   Calculates statistics for entropy data (theta segments).
%   2ENTRYSTAT4_THETA runs on the output of ENTRYRUN_THETA or ENTRYRUN3. Edit
...
fn = [DATAPATH 'Entry3_cont2\Stat\power\2theta.xls'];
fnm = [DATAPATH 'Entry3_cont2\Stat\power\stat_2theta.mat'];
