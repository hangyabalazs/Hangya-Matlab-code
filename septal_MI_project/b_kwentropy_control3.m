function b_kwentropy_control3
%KWENTROPY_CONTROL3   Wavelet entropy calculation.
%   KWENTROPY_CONTROL3 calculates wavelet magnitude entropies for MEGAWAVERUN_ENTRCTRL2 output
...
wh_to = [DATAPATH 'Entropy\control\random_unit\'];
files = dir(wh_from);
files = files(3:end);
...
% Progress indicator
wb = waitbar(0,'Running KWENTROPY CONTROL3...','Position',[360 250 275 50]);    %Progress indicator
global WB
WB(end+1) = wb;
