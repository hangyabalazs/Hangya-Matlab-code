function b_5kwentropy
%5KWENTROPY   Wavelet entropy calculation.
%   5KWENTROPY calculates wavelet magnitude entropies for MEGAWAVERUN_ENTRCTRL2 output files. 
%   It calls ENTR2 for the raw entropy calculation. It computes entropy for the theta band 
%   only and normalizes for the whole theta band. Being a fifth generation entropy calculating 
%   program, it computes entropy for 1-10 Hz frequency band. It uses 1 sec. long, 50 % overlaping
%   windows. Outputs:
...
% Progress indicator
wb = waitbar(0,'Running 5KWENTROPY...','Position',[360 250 275 50]);    %Progress indicator
global WB
WB(end+1) = wb;
