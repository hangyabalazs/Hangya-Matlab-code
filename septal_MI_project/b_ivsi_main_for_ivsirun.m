function [burstloc,intervals,minimums,o,H] = b_ivsi_main_for_ivsirun(wts);
%IVSI_MAIN_FOR_IVSIRUN  Version of IVSI_MAIN used by IVSIRUN.
%   IVSI_MAIN has five output arguments: first contains the localization of the first spikes of
%   bursts, second contains the localization of the first and last points of the theta intervals
%   of the eeg, third contains the localization of the eeg minimums, o is the handle of "ivsi plot"
%   and H is the handle of "bursts plot".
%   The input argument hides the decision whether you wish to save the number of clusters.
%
...
[burstloc,bursting,H] = b_burst_cls_for_ivsirun(wts);

% Return if there are not any bursts
if bursting == 0,
    intervals = [];
    minimums = [];
    o = [];
...
[intervals,minimums] = b_wavephase_for_ivsirun;
...
xlabel('Length of theta interval');
ylabel('Length of inter-1st-spike interval');
hold on;
