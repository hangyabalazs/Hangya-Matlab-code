function [NothNoburst,NothBurst,NN,NB] = b_2entrymorestat4_noth
%2ENTRYMORESTAT4_NOTH   Calculates statistics for entropy data (non-theta segments).
%   2ENTRYMORESTAT4_NOTH runs on the output of ENTRYRUN_THETA or ENTRYRUN3C. Edit
...
fn = [DATAPATH 'Entry3c\Stat\power\2noth_entropy.xls'];
fnm = [DATAPATH 'Entry3c\Stat\power\stat_2noth_entropy.mat'];
