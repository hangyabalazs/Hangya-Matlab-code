function b_entryrun_theta2_cont2
%ENTRYRUN_THETA2_CONT2   Runs entropy and PDC on a sequence of theta segments.
%   ENTRYRUN_THETA2_CONT2 calculates wavelet power and wavelet phase entropy
...
%   details).
%
%   See also DTF, 2DTF, ENTRY, ENTRYRUN3_CONT2 and ENTRYRUN_THETA2.
...
resdir = [DATAPATH 'Entry0_cont2\Theta\'];
datadir = DATADIR2;
...
% Progress indicator
wb = waitbar(0,'Running ENTRYRUN THETA2 CONT2...','Position',[360 250 275 50]);
global WB
WB(end+1) = wb;
