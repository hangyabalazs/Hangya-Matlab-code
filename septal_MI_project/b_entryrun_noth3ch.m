function b_entryrun_noth3ch
%ENTRYRUN_NOTH3CH   Runs entropy and PDC on a sequence of non-theta segments.
%   ENTRYRUN_NOTH3CH calculates wavelet power and wavelet phase entropy for
...
%
%   ENTRYRUN_NOTH3CH runs on converted 3-channel data files and calculates
...
global DATAPATH
global DATADIR
inpdir = [DATAPATH 'Burst\Cluster\Noth_3ch\'];   % input directory
resdir = [DATAPATH 'Entry_unitunit\Noth\'];
...
% Progress indicator
wb = waitbar(0,'Running ENTRYRUN NOTH3CH...','Position',[360 250 275 50]);
global WB
WB(end+1) = wb;
