function [wavea,waveb,wavec,waved,wavee] = b_megawave_entrctrl2(eeg,vdisc)
%MEGAWAVE_ENTRCTRL2   Calculates wavelet transform for unit, eeg, random sample, random generated and delayed unit.
...
%
%   [A,B,C,D,E] = MEGAWAVE_ENTRCTRL(EEG,VDISC) returns 5 output arguments: eeg wavelet (A), unit 
%   wavelet (B), random sample wavelet (C), random generated unit wavelet (D), delayed unit wavelet
%   (E). Random generated unit is a randomized Poisson process.
%
%   See also MEGAWAVE_ENTRCTRL and MEGAWAVERUN_ENTRCTRL2.
...
wavee = unit_wavelet(dvd,lenu);     % delayed unit
