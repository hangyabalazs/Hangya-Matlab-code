function varargout = b_ica_gui2b(varargin)
%ICA_GUI2B   Graphical User Interface for Iterative Cluster Analysis.
%   ICA_GUI2B shows the result of variance analysis, return plot or spike train,
%   Lomb-Scargle periodograms, 'wavelet vectors' and their Fourier spectra.
%
...
%
%   Return plot or spike train: use the lower listbox or the mouse buttons to switch
%   between return plot or spike train for different cluster numbers. Intraburst
%   spikes are red. If you choose 'FFT' from the second 'View' menu, you can use
%   'y', 'x', 'c' and 'v' buttons to superimpose 'wavelet vectors' on the spike
%   train or 'l' button to crossline bursts.
%
%   Lomb-Scargle periodograms: choose 'Lomb periodogram' or 'FFT' in the second 
%   'View' menu to see Lomb periodograms of the Blackmann-Harris convolved unit
%   sampled at the time of intraburst spikes. See PERIODRUN for details.
%
%   'Wavelet vectors': choose 'Wavelet vectors' or 'FFT' in the second 'View'
%   menu to see 'Wavelet vectors' or choose 'FFT' to see their Fourier spectra.
%   You can switch between frequency bands using 'q' and 'w' buttons or switch
%   'zoom xon' using 'z' button (see CALLFFTSWITCH for details). See ICA_WAVE
%   for details on 'Wavelet vectors' ('Wavelet average magnitude vectors').
%
...
%   for details.
%
%   You are able to export figures from the GUI by pressing 'e', 'r', 't' or 'z'
%   buttons. See CALLEXPORTFIG0 for details.
%
%   See also ICA_WAVE and ICA_ANAL.
