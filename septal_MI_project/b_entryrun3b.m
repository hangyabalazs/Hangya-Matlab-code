function b_entryrun3b
%ENTRYRUN3B   Runs entropy and PDC on a sequence of recordings.
%   ENTRYRUN3B calculates wavelet power and wavelet phase entropy for theta
...
%
%   ENTRYRUN3B attaches theta and non-theta segment together and completes
