function [Noth,N] = b_entry3chstat_noth
%ENTRY3CHSTAT_NOTH   Calculates statistics for entropy data (non-theta segments).
%   ENTRY3CHSTAT_NOTH runs on the output of ENTRYRUN_3CH. Edit code to
...
%
%   See also ENTRY3CHSTAT_THETA and ENTRYSTAT_NOTH.
...
fn = [DATAPATH 'Entry2_unitunit\Stat\DTF_halfsec\noth_rorc.xls'];
fnm = [DATAPATH 'Entry2_unitunit\Stat\DTF_halfsec\stat_noth_rorc.mat'];
