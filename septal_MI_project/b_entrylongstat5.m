function b_entrylongstat5
%ENTRYLONGSTAT5   Calculates statistics for whole registration uncert. coeff.
%   ENTRYLONGSTAT5 calculates and saves t-test, Wilcoxon signrank-test and
...
% Progress indicator
wb = waitbar(0,'Running ENTRYLONGSTAT5...','Position',[360 250 315 50]);    %Progress indicator
global WB
WB(end+1) = wb;
