function [intraburstiv_cv,extraburstiv_cv,interburstiv_cv,firstspike_cv,allfirstspike_cv,...
        ...
        Burst,Ccc] = b_itclust(vdisc,d,method)
%ITCLUST   Iterative clustering.
%   ITCLUST(VDISC,D,METHOD) clusters the input argument VDISC (discriminated unit) using the "iterative 
...
%
%   See also ICA_NEWAVE, CLUSTER, COPHENET, INCONSISTENT, ITCLUST2 and NATCLUST.
