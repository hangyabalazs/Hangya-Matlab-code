function [NothNoburst,NothBurst,NN,NB] = b_2entrystat2_noth
%2ENTRYSTAT2_NOTH   Calculates statistics for entropy data (non-theta segments).
%   2ENTRYSTAT2_NOTH runs on the output of ENTRYRUN_NOTH or ENTRYRUN3. Edit
...
fn = [DATAPATH 'Entry3_cont2\Stat\power\noth_rorc.xls'];
fnm = [DATAPATH 'Entry3_cont2\Stat\power\stat_noth_rorc.mat'];
