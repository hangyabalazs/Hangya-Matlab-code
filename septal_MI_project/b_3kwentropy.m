function b_3kwentropy
%3KWENTROPY   Wavelet entropy calculation.
%   3KWENTROPY calculates wavelet magnitude entropies for MEGAWAVERUN_ENTRCTRL2 output files. 
%   It calls ENTR2 for the raw entropy calculation. Being a third generation entropy function,
%   it computes entropy for the theta band only and normalizes for the whole theta band. It
%   uses 5 sec. long, 90 % overlaping windows. Outputs:
...
% Progress indicator
wb = waitbar(0,'Running 3KWENTROPY...','Position',[360 250 275 50]);    %Progress indicator
global WB
WB(end+1) = wb;
