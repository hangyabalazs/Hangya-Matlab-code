...
%   delay and scale parameter. Initial parameters can be set by editing the
%   first part of the program code.
%
%   See also ZSHIFTRUN5 and SIMZSHIFT2.

% Initial parameters
sr = 1000;      % sampling rate: 1000 Hz
len = 10;       % segment length: 10 s
np = 0.1;       % proportion of Gaussian noise to add, 0.1
tp = 0.3;       % transfer rate, 0.3
...
% Zshift
H = figure;
[zmaxloc,zmax,hang,hmvl] = zshift(H,eeg,vdisc,sr);
...
% ----------------------------------------------------------------------------------
function [zmaxloc,zmax,hang,hmvl] = zshift(H,eeg,vdisc,sr)
