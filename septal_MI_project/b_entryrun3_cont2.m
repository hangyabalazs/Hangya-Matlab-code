function b_entryrun3_cont2
%ENTRYRUN3_CONT2   Runs entropy and PDC on a sequence of recordings.
%   ENTRYRUN3_CONT2 calculates wavelet power and wavelet phase entropy for 
...
%
%   ENTRYRUN3_CONT2 attaches theta and non-theta segment together and 
...
resdir = [DATAPATH 'Entry3_cont2\Theta\'];
datadir = DATADIR2;
