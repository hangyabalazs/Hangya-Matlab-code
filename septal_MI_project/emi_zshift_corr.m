function [Stats_eu, Stats_ue, STeu, STue] = emi_zshift_corr
%EMI_ZSHIFT_CORR   Calculates relation of mutual information and zshift.
%   EMI_ZSHIFT_CORR runs on the output of ENTRYRUN3C and EZSHIFTRUN. Edit
%   code to specify exact directories!
%
%   It runs on entropy results, and addresses the question whether mutual
%   information is correlated with zshift in anatomically defined
%   categories of identified cells.
%
%   See also EMISTAT, ENTRYRUN3C and EZSHIFTRUN.
...
% Load table
ff = [DATAPATH '5UEntropy\allcells'];   % load identification data
[tbl0 tbl] = xlsread(ff);
