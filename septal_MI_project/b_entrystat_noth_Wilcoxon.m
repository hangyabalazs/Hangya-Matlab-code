function [NothNoburst,NothBurst,NN,NB] = b_entrystat_noth_Wilcoxon
%ENTRYSTAT_NOTH_WILCOXON   Calculates statistics for entropy data (non-theta segments).
%   ENTRYSTAT_NOTH_WILCOXON runs on the output of ENTRYRUN_THETA or
...
%
%   See also ENTRYSTAT_THETA_WILCOXON.
