function cz2phase_17
%CZ2PHASE_17   Modified version of CZ2PHASE.
%   CZ2PHASE_17 reads unit from txt input files.
%
%   See also CZ2PHASE and CZ2PHASE_29.

% Directories
global DATAPATH
inpdir_unit = [DATAPATH 'Czurko2\units\'];
inpdir_EEG = [DATAPATH 'Czurko2\EEG\'];
EEGtable = [DATAPATH 'Czurko2\inter_anal_02d_L_2SD_depth_2jmp_DG_OSC2_2blzs_bh.xls'];
resdir = [DATAPATH 'Czurko2\Phase\'];
...
for o = 17:18
    ...
    [un1 un2] = textread('X:\In_Vivo\balazs\_analysis\Czurko2\EEG\ac10s013_CSC13.txt','%f %f');
    eeg_times = un1';
    eeg = -un2';
