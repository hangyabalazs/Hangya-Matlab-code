function cz2phase_11
%CZ2PHASE_11   Modified version of CZ2PHASE.
%   CZ2PHASE_11 reads unit from txt input files.
%
...
for o = 11:11
    ...
    [un1 un2] = textread('X:\In_Vivo\balazs\_analysis\Czurko2\EEG\ac09s12N_CSC13.txt','%f %f');
    eeg_times = un1';
    eeg = -un2';
