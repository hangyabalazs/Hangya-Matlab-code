function varargout = b_analyse2(varargin)
% B_ANALYSE2 Application M-file for b_analyse2.fig
%    FIG = B_ANALYSE2 launch b_analyse2 GUI.
%    B_ANALYSE2('callback_name', ...) invoke the named callback.

% Last Modified by GUIDE v2.5 25-Feb-2008 14:58:16
...
set(fig,'Color',get(0,'DefaultUicontrolBackgroundColor'));
    ...
    handles.burstnum = -1;
    global DATAPATH
    burstdir = [DATAPATH 'Andi\Ketxyl\Cluster\mat2\control\'];
    burstdir0 = [DATAPATH 'Andi\Ketxyl\Cluster\mat\control\'];
    ...
    Cstart = imread(['C:\MATLAB_R2007a\work\Balazs\doubleleft_arrow.bmp']);
    Cprev = imread([ 'C:\MATLAB_R2007a\work\Balazs\left_arrow.bmp']);
    Cnext = imread([ 'C:\MATLAB_R2007a\work\Balazs\right_arrow.bmp']);
    Clast = imread([ 'C:\MATLAB_R2007a\work\Balazs\doubleright_arrow.bmp']);
...
set(gcf,'KeypressFcn','b_analyse2(''b_callfftswitch'',''eeg'')');
...
% Set keypress function
set(gcf,'KeypressFcn','b_analyse2(''b_callfftswitch'',''unit'')');
...
% Set buttondown functions
bdf1 = 'b_analyse2(''axes_eeg_ButtonDownFcn'',gcbo,[],guidata(gcbo))';
bdf2 = 'b_analyse2(''axes_unit_ButtonDownFcn'',gcbo,[],guidata(gcbo))';
