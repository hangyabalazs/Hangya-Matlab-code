function b_zoom_for_wavelet
%ZOOM_FOR_WAVELET  Zoom in and out on a 2-D plot.
%   ZOOM_FOR_WAVELET acts similar to ZOOM. You can modify each step individualy
%   and assign ZOOM_FOR_WAVELET as figure ButtonDownFcn with ZOOMSET_FOR_WAVELET.
%
%   ZOOM_FOR_WAVELET 'rescales' figure after each zooming. Note, that you
%   have to define the scale vectors as application data, so include the
