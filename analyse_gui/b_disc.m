function b_disc(kuszob2)
%DISC   Dicriminator for raw unit data.
%   DISC converts unit into a series of time values.
...
%
%   DISC(KUSZOB) does the discrimination using KUSZOB as threshold.
%
