function varargout = b_analyse5(varargin)
% B_ANALYSE5 Application M-file for b_analyse5.fig
%    FIG = B_ANALYSE5 launch b_analyse5 GUI.
%    B_ANALYSE5('callback_name', ...) invoke the named callback.
...
cd('F:\raw_data\ms_neuron_matfiles\')
[filename, pathname] = uigetfile({'*.mat', 'All MAT-Files (*.mat)'; ...
    '*.*','All Files (*.*)'},'Select Datafile');
