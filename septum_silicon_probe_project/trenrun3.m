function trenrun3
%TRENRUN3   Calculates transfer entropy on a sequence of recordings.
%   TRENRUN3 calculates wavelet power transfer entropy for the longest theta
...
%
%   TRENRUN3 calculates optimal tau value by maximizing NTE.
%
%   See also TREN.
...
resdir = [DATAPATH 'TE\second_try_tauNTEmax_hc\'];
