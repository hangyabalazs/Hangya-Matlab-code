function trtrenrun_modTP
%TRTRENRUN_MODTP   Calculates time-resolved transfer entropy.
%   TRTRENRUN_MODTP calculates wavelet power transfer entropy for the
...
%
%   TRENRUN3_MODTP applies a corrected version of TP bias correction.
%
...
inpdir_tau = [DATAPATH 'TE\second_try_tauNTEmax_modTP\'];   % input directory
resdir = [DATAPATH 'TE\timeresolved_tauNTEmax_modTP\'];
