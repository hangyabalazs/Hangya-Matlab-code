function trtrenrun
%TRTRENRUN   Calculates time-resolved transfer entropy.
%   TRTRENRUN calculates wavelet power transfer entropy for the longest
%   theta and non-theta segments in one-second windows. (The segments are
%   attached together for wavelet calculation and extrema for
...
inpdir_tau = [DATAPATH 'TE\second_try_tauNTEmax_hc\'];   % input directory
resdir = [DATAPATH 'TE\timeresolved_tauNTEmax_hc\'];
...
% Transfer entropy
    ...
    for i = 1:mmax        % THETA LOOP
        ...
        TE_theta_eu_shuffled(i) = TE_corr;
        ...
        TE_theta_ue_shuffled(i) = TE_corr;
