function [aang aang_cfsp resdir1] = L5_spiking_5percent_nocut(inpdir1)
%L5_SPIKING_5PERCENT_NOCUT   Phase analysis for layer 5 pyramidal neurons.
%   [A A_CFSP D] = L5_SPIKING_5PERCENT_NOCUT(DR) calculates phase
%   histograms for all spikes (A) and cycle first spikes (A_CFSP). Input
%   directory (DR) is specified in the caller function and results
%   directory (D) is returned to the same caller. 
%
%   Note: Unlike in L5_SPIKING_5PERCENT, segment are not cut at a
%   predefined time!
%
...
%
%   See also L5_SPIKING_5PERCENT and AFRE_RESTRICT_STAND_LAYER5.
...
% Directories
global DATAPATH
resdir1 = [DATAPATH 'Hajni_layer_5\L5_spiking_5percent_nocut\'];
mm = pwd;
