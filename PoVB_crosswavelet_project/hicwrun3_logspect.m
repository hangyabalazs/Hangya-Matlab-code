function hicwrun3_logspect
%HICWRUN3_LOGSPECT   Runs crosswavelet on a sequence of files.
%   HICWRUN3_LOGSPECT calculates and saves logarithmic wavelet and
%   crosswavelet images.
%
...
resdir = [DATAPATH 'Hajni\EEGMPO_new\crosswavelet_logspect\'];
mm = pwd;
...
% Progress indicator
wb = waitbar(0,'Running HICWRUN3 LOGSPECT...','Position',[360 250 275 50]);
global WB
WB(end+1) = wb;
