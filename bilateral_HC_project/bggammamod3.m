function bggammamod3(data,trials)
%BGGAMMAMOD3   Modulation of gamma power by theta phase.
%   BGGAMMAMOD3(DATA,TRIALS) compares the modulation of gamma power by theta
...
%
%   See also BGMI, BGGAMMAMOD, BGGAMMAMOD2 and BGGAMMAMOD4.
