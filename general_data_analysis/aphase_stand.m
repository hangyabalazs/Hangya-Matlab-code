function [ang inx] = aphase_stand(eeg,vdisc,sr)
%APHASE_STAND    Phase angles for unit relative to EEG.
%   [A I] = APHASE_STAND(EEG,VDISC,SR) calculates Hilbert phase angles (A)
...
%   2 criteria are discarded: (i) EEG amp. higher then 2SD; (ii) min. 250
