function [T,seglen] = b_thres2
%THRES2  Automatic unit thersholding.
%   THRES2 determines the threshold through the follwing algorithm: it seeks the
...
%
%   THRES2, unlike THRES segments long data and returns an array of threshold values.
%   [T,SEGLEN] = THRES2 returns the length of unit segments as well.
%
%   See also THRES, THRES3, THRES4 and THRESRUN.
