...
%   whatsoever.
%----------------------------------------------------------------------------
function [wave,period,scale,coi] = b_wavelet_new2(Y,dt,pad,dj,s0,J1,mother,param,mis);
%WAVELET_NEW2   Wavelet optimalized for memory usage.
%   WAVELET_NEW2 saves the variables of the caller function to disc and reloads it
...
%   use WAVELET_NEW3.) Some other memory conserving modifications were made on the
%   original WAVELET function.
%
%   See also WAVELET_NEW3, WAVELET_POW2 and WAVELET_POW3.
