function [T,seglen] = b_thres5
%THRES5   Automatic unit thersholding.
%   THRES5 determines the threshold through the follwing algorithm: it seeks the
...
%
%   THRES5, unlike THRES segments long data and returns an array of threshold values.
%   [T,SEGLEN] = THRES5 returns the length of unit segments as well.
%
%   THRES5 can handle pseudounit as well. It does not plot the result.
%
%   See also THRES, THRES2, THRES3, THRES4 and THRESRUN.
