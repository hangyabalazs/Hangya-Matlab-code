...
%   whatsoever.
%----------------------------------------------------------------------------
function [pow,period,scale,coi] = b_wavelet_pow3(Y,dt,pad,dj,s0,J1,mother,param,mis);
%WAVELET_POW3   Wavelet power optimalized for memory usage.
%   Some memory conserving modifications were made on the original WAVELET function.
%   To reach the best memory perfofmance, use WAVELET_POW2 (execution will be slower).
%
%   See also WAVELET_POW2, WAVELET_NEW2 and WAVELET_NEW3.
