...
%   whatsoever.
%----------------------------------------------------------------------------
function [wave,period,scale,coi] = b_wavelet_new(Y,dt,pad,dj,s0,J1,mother,param);
%WAVELET_NEW   Wavelet optimalized for memory usage.
%   Some memory conserving modifications were made on the original WAVELET function.
%
%   See also WAVELET_NEW2 and WAVELET_NEW3.
...
% Free memory
clear f daughter fourier_factor dofmin dt J1
