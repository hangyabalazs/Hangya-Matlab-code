...
%   memory test). Semantically related pairs of nouns (30) are presented in
%   a randomized order (1/7 s presentation rate, 100 ms interstim. iv.). 
...
% Task description
cgtext('A következõkben 38 szópárt fog látni.',0,250);
