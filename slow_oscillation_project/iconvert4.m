function iconvert4
%ICONVERT   Converts trc to mat.
%   ICONVERT loads OITI trc files and saves mat files.
%
%   For OITI_N1_ (wittner)
%
%   See also ICHANMATCH.

% Load
trcfile = 'X:\In_Vivo\balazs\_analysis\Ulbert\OITI_N1_EEG_157\MImap\EEG_157.trc';
fid = fopen(trcfile);
...
disp(['Channels:'])
disp(chnames([20:23 28:31 36:39 44:47]'))

% Save
data = trcdata(:,[20:23 28:31 36:39 44:47]);
