function imisignio(pat,patno,eg,nm_rows,nm_cols,esg)
%IMISIGNIO   Input-output function.
%   IMISIGNIO calculates input-output function for significant propagation
%   events. Data is plotted and saved for each channels. Optional input
%   arguments:
...
try
    resdir = [DATAPATH 'Ulbert\OITI_' patno '_EEG_' eg '\IOsign\'];
    cd(resdir)
catch
    mkdir(resdir)
    cd(resdir)
