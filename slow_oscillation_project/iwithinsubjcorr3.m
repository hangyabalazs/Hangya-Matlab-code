function iwithinsubjcorr3(pno,pt,egs)
%IWITHINSUBJCORR3   Within-subject correlations.
%   IWITHINSUBJCORR3 calculates within-subject correlation of convergence
%   pattern to the electrode receiving the most convergent input. See
%   IMISORUN for details on the above variables.
%
%   IWITHINSUBJCORR3(PNO,PT,EGS) requires 3 string input arguments:
%       PNO: patient ID
%       PT: patient name
%       EGS: EEG file IDs
%
...
xlsname = [resdir 'hubconvcorr.xls'];   % write results to excel file
