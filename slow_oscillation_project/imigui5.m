function varargout = imigui5(varargin)
% IMIGUI5 M-file for imigui5.fig
%      IMIGUI5, by itself, creates a new IMIGUI5 or raises the existing
%      singleton*.
%
%      H = IMIGUI5 returns the handle to a new IMIGUI5 or the handle to
%      the existing singleton*.
%
%      IMIGUI5('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in IMIGUI5.M with the given input arguments.
%
%      IMIGUI5('Property','Value',...) creates a new IMIGUI5 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before imigui5_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to imigui5_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help imigui5
