function varargout = imigui6_control(varargin)
% IMIGUI6_CONTROL M-file for imigui6_control.fig
%      IMIGUI6_CONTROL, by itself, creates a new IMIGUI6_CONTROL or raises the existing
%      singleton*.
%
%      H = IMIGUI6_CONTROL returns the handle to a new IMIGUI6_CONTROL or the handle to
%      the existing singleton*.
%
%      IMIGUI6_CONTROL('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in IMIGUI6_CONTROL.M with the given input arguments.
%
%      IMIGUI6_CONTROL('Property','Value',...) creates a new IMIGUI6_CONTROL or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before imigui5_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to imigui6_control_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help imigui6_control
...
ff = [DATAPATH 'Ulbert\EEG_12\MImap\MIshiftcontrolfine2.mat'];
load(ff)
...
fn = 'F:\raw_data\human_SO\oiti37_lukacs\grid\mat_EEG_12\arteficial_control2.mat';
load(fn)
data = data(1:end-7,:);
handles.data = data;
