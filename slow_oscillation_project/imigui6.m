...
ff = [DATAPATH 'Ulbert\EEG_12\MImap_SNRcontrol3\siglev_EEG12.mat'];
load(ff)
handles.siglev = sl;

% Load MI shift data
% ff = [DATAPATH 'Ulbert\OITI_' pt '_EEG_' eg '\MImap\MIshiftfine.mat'];
ff = [DATAPATH 'Ulbert\EEG_12\MImap_SNRcontrol3\MIshiftfine.mat'];
load(ff)
...
fn = 'F:\raw_data\human_SO\oiti37_lukacs\grid\mat_EEG_12\arteficial_control_snr3.mat';
load(fn)
data = data(1:end-7,:);
handles.data = data;
