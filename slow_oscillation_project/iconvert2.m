function iconvert2
%ICONVERT2   Converts trc to mat.
%   ICONVERT2 loads OITI trc files and saves mat files.
%
%   For OITI31_virag.
%
%   See also ICHANMATCH.
...
% Load
trcfile = 'D:\human_SO\oiti31_virag\grid\EEG_285.trc';
fid = fopen(trcfile);
