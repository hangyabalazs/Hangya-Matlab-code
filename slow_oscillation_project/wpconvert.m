function wpconvert
%WPCONVERT   Converts trc to mat.
%   WPCONVERT loads OITI trc files and saves mat files.
%
%   For OITIN1_wittner.
%
%   See also ICHANMATCH.
...
% Load
trcfile = 'X:\In_Vivo\raw_data\human_SO\oitin1_wittner\grid\mat_EEG_157\EEG_157.trc';
fid = fopen(trcfile);
