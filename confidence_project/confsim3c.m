function confsim3c
%CONFSIM3C   Simlulate confidence based on the normative model.
%   CONFSIM3C runs a normative model for confidence and tests the
...
%   numbers. Other choice models are easy to implement in this version (see
%   some commented choice options in the code). 10000 trials are simulated
%   and confidence is based on the distribution of all trials. Note that
...
%
%   See also CONFSIM2, CONFSIM3, CONFSIM3 and CONFSIM3B.
...
choice = double(d_hat<0);   % inverse choice
% choice = randi([0 1],1,NumTrials);   % random decision
% choice = ones(1,NumTrials);   % invariable decision

% Outcome
outcome = (choice & l > r) | (~choice & l < r);
