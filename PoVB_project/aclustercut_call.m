function aclustercut_call
%ACLUSTERCUT_CALL    Save desired number of clusters and number of missed spikes.
%   ACLUSTERCUT_CALL runs ACLUSTERCUT for a single file. See ACLUSTERCUT
%   for details.
%
...
% Filelist
fname1 = uigetfile(inpdir1);
fname2 = [fname1(1:end-4) '.fig'];
