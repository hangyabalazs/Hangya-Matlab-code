function afre_restrict_gamma(inpdir1)
%AFRE_RESTRICT_GAMMA   Beta phase analysis restricted to a frequency band.
%   AFRE_RESTRICT_GAMMA(DR) calculates and saves beta phase (10 - 20 Hz)
...
%   given as an argument (DR).
%
%   See also APHASE_GAMMA and AFRERESTRICT_GAMMA_CALL.
...
resdir1 = [DATAPATH 'Andi\Ketxyl\FreBandRestrict_phase_gamma2\'];
mm = pwd;
