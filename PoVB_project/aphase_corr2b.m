function aphase_corr2b(inpdir1)
%APHASE_CORR2B   Correlation between EEG frequency and firing pattern.
%   APHASE_CORR2B(DR) calculates and saves correlation between 
...
resdir = [DATAPATH 'Andi\Ketxyl\PhaseCorr2b\'];
mm = pwd;
...
% Progress indicator
[wb,awb1,awb2] = waitbar2([0 0],'Running APHASE CORR2B...');
global WB
WB(end+1) = wb;
...
preR1 = corrcoef(meanang,fre);    % correlation between mean angle and EEG frequency
preR2 = corrcoef(brstness,fre);    % correlation between burstiness and EEG frequency
if numel(preR1) == 1
    Rangfre = preR1;
    Rburstfre = preR2;
else
