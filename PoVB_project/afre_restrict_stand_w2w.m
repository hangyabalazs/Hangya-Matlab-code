function afre_restrict_stand_w2w(inpdir1)
%AFRE_RESTRICT_STAND_W2W   Phase analysis restricted to a frequency band.
%   AFRE_RESTRICT_STAND_W2W(DR) calculates and saves wave-to-wave phase
%   analysis results for a given EEG frequency band (1.1 - 1.6 Hz). Input
...
resdir1 = [DATAPATH 'Andi\Ketxyl\FreBandRestrict_phase_stand_w2w_2\'];
resdir2 = [];
mm = pwd;
