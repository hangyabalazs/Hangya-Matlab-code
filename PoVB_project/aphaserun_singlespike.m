function aphaserun_singlespike
%APHASERUN_SINGLESPIKE    Runs APHASE2 and ASTANORM on a sequence of files.
%   APHASERUN_SINGLESPIKE loads EEG, discriminated unit and burst data, calls 
%   APHASE2 and ASTANORM and saves results. Edit the program code to modify
%   the input and result directories.
%   
%   APHASERUN_SINGLESPIKE uses single spikes as events (and disregards 
%   bursts).
%
%   See also APHASE2, ASTANORM, APHASERUN_BURST and APHASERUN_1STSPIKE.
...
resdir1 = [DATAPATH 'Andi\Ketxyl\Phase_single\'];
resdir2 = [DATAPATH 'Andi\Ketxyl\STA_single\'];
mm = pwd;
...
for o = 1:sf
    ...
    [aang cyclen1 cyclen2 cl] = aphase2(eeg,sspo,sr);    % PHASE
    n = length(aang);
    ...
    [sta sta_index1 sta_index2 nn] = astanorm(sspo,eeg,wn);    % STA
