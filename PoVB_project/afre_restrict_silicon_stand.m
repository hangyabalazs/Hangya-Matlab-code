function afre_restrict_silicon_stand
%AFRE_RESTRICT_SILICON_STAND   Phase analysis restricted to a frequency band.
%   AFRE_RESTRICT_SILICON_STAND calculates and saves phase analysis results
%   for a given EEG frequency band (1.1 - 1.6 Hz) of silicon probe data.
%   EEG is standardized for phase calculations. See APHASE_STAND for
%   details on the analysis.
%
%   See also APHASE_STAND and AFRE_RESTRICT.
...
% Directories
global DATAPATH
inpdir = ['Y:\Names\Peter\balazs\sil3\'];
resdir = [DATAPATH 'Andi\Ketxyl\FreBandRestrict_phase_silicon_stand\sil3\t2\'];
mm = pwd;
...
for o = 1:sf
    ...
    for nc = 2:ncells
        ...
        for k = 1:lenr
            ...
            eeg2 = loceeg(round(1:const:end));    % downsample on 1000 Hz
