...
%   AFRE_RESTRICT(DR) calculates and saves phase and burst analysis results
%   for a given EEG frequency band (1.1 - 1.6 Hz). See ACLUSTERCUT and
%   APHASE_BURST2_STAND for details on the analysis. Input directory should
%   be given as an argument (DR).
%
...
resdir1 = [DATAPATH 'Andi\Ketxyl\FreBandRestrict_phase_temp\'];
resdir2 = [DATAPATH 'Andi\Ketxyl\FreBandRestrict_burst_temp\'];
mm = pwd;
...
save(fn,'aang_fs','aang_sp','aang_as','aang_afsp','aang_ibsang',...
    'aang_sspoang','aang_allang','cycnb');
