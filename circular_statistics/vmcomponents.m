function [pvalue AIC BIC] = vmcomponents(theta,degrad)
%VMCOMPONENTS   Estimates the number of von Mises components.
%   [P AIC BIC] = VMCOMPONENTS(THETA,DEGRAD) performs statistical tests
...
resdir = [DATAPATH 'Czurko2\VMfit\bootstrap\'];
