function snwcoherence2(rrat,rdate,csc1,csc2,msgn,thr,wl)
%SNWCOHERENCE2   Coherence between whisking and respiration cycle.
%   SNWCOHERENCE2 calculates mean-square coherence between whiking root-mean
%   square and sniffing. Sniffing is low-pass filtered at 30 Hz and
%   whisking is high-pass filtered at 10 Hz.
%
%   SNWCOHERENCE2(RAT,DATE,CSC1,CSC2,MSGN,THR,WL) accepts input arguments
...
global DATAPATH
global DATADIR
resdir = [DATAPATH 'SniffWhisk\coherence_speed\'];
...
% Position data
fn = [DATADIR 'HSW\' rrat '\' rdate '\VT1.nvt'];
