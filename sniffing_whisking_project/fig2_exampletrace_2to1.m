...
uiopen('C:\Balazs\_analysis\SniffWhisk\Fig_examples\example1_2to1_sniff2.fig',1)
...
uiopen('C:\Balazs\_analysis\SniffWhisk\Fig_examples\example1_2to1_whisk2.fig',1)
...
% A2 = subplot(212);
lnn2 = copyobj(ln2,A2);
set(lnn2,'Color',[0 153 255]/255,'LineWidth',2)  % ,'Color',[153 0 255]/255)      % blue: [0 153 255]/255, green: [0 153 0]/255
