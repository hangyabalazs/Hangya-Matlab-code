...
Pv_CCG_pairs_WS1 = pv_CCG_pairs_WS;
Som_CCG_pairs_WS1 = som_CCG_pairs_WS;
...
Pv_CCG_pairs_WS2 = pv_CCG_pairs_WS;
Som_CCG_pairs_WS2 = som_CCG_pairs_WS;
...
Pv_CCG_pairs_WS1 = Pv_CCG_pairs_WS1(:,7:207);
Som_CCG_pairs_WS1 = Som_CCG_pairs_WS1(:,7:207);
...
Pv_CCG_pairs_WS2 = Pv_CCG_pairs_WS2(:,7:207);
Som_CCG_pairs_WS2 = Som_CCG_pairs_WS2(:,7:207);
...
pvn1 = smoothallcells(Pv_CCG_pairs_WS1);   % PV-pairs, HomeZoneOut
somn1 = smoothallcells(Som_CCG_pairs_WS1);   % SOM-pairs, HomeZoneOut
...
pvn2 = smoothallcells(Pv_CCG_pairs_WS2);   % PV-pairs, HomeZoneIn
somn2 = smoothallcells(Som_CCG_pairs_WS2);    % SOM-pairs, HomeZoneIn
