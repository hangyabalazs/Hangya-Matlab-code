...
for k = 1:sizepv(1)
    sj_pv1(k) = sum(spv1(k,inx2));
end

sj_som1 = zeros(1,sizesom(1));
for k = 1:sizesom(1)
    sj_som1(k) = sum(ssom1(k,inx2));
end

sj_nt1 = zeros(1,size(snt1,1));
for k = 1:size(snt1,1)
    sj_nt1(k) = sum(snt1(k,inx2));
end

sk_pv1 = zeros(1,sizepv(1));
for k = 1:sizepv(1)
    sk_pv1(k) = sum(spv1(k,inx3));
end

sk_som1 = zeros(1,sizesom(1));
for k = 1:sizesom(1)
    sk_som1(k) = sum(ssom1(k,inx3));
end

sk_nt1 = zeros(1,size(snt1,1));
for k = 1:size(snt1,1)
    sk_nt1(k) = sum(snt1(k,inx3));
end

sl_pv1 = zeros(1,sizepv(1));
for k = 1:sizepv(1)
    sl_pv1(k) = sum(spv1(k,inx4));
end

sl_som1 = zeros(1,sizesom(1));
for k = 1:sizesom(1)
    sl_som1(k) = sum(ssom1(k,inx4));
end

sl_nt1 = zeros(1,size(snt1,1));
for k = 1:size(snt1,1)
    sl_nt1(k) = sum(snt1(k,inx4));
end


si_pv2 = zeros(1,sizepv(1));
for k = 1:sizepv(1)
    si_pv2(k) = sum(spv2(k,inx1));
end

si_som2 = zeros(1,sizesom(1));
for k = 1:sizesom(1)
    si_som2(k) = sum(ssom2(k,inx1));
end

si_nt2 = zeros(1,size(snt2,1));
for k = 1:size(snt2,1)
    si_nt2(k) = sum(snt2(k,inx1));
end
...
sk_pv2 = zeros(1,sizepv(1));
for k = 1:sizepv(1)
    sk_pv2(k) = sum(spv2(k,inx3));
end

sk_som2 = zeros(1,sizesom(1));
for k = 1:sizesom(1)
    sk_som2(k) = sum(ssom2(k,inx3));
end

sk_nt2 = zeros(1,size(snt2,1));
for k = 1:size(snt2,1)
    sk_nt2(k) = sum(snt2(k,inx3));
end

sl_pv2 = zeros(1,sizepv(1));
for k = 1:sizepv(1)
    sl_pv2(k) = sum(spv2(k,inx4));
end

sl_som2 = zeros(1,sizesom(1));
for k = 1:sizesom(1)
    sl_som2(k) = sum(ssom2(k,inx4));
end

sl_nt2 = zeros(1,size(snt2,1));
for k = 1:size(snt2,1)
    sl_nt2(k) = sum(snt2(k,inx4));
end
...
vars = [[si_pv2 si_som2 si_nt2]' [sj_pv2 sj_som2 sj_nt2]' ...
    [sk_pv2 sk_som2 sk_nt2]' [sl_pv2 sl_som2 sl_nt2]'];
celltypes = {1:sizepv(1); sizepv(1)+1:sizepv(1)+sizesom(1); sizepv(1)+sizesom(1)+1:size(vars,1)};
