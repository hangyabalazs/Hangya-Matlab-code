function [p_value Idiff p_value2 Idiff2 p_value3 Idiff3 p_value4 Idiff4] = ...
    somisstim2(cellid)
%SOMISSTIM2   Assessment of optic tagging.
%   [P1 I1 P2 I2 P3 I3 P4 I4] = SOMISSTIM2(CELLID) calculates information
...
if nargin < 2
    win = [-0.6 0.6];  % time window for bin raster
...
[p_value Idiff p_value2 Idiff2 p_value3 Idiff3 p_value4 Idiff4] = ...
    isikldist(spt,dtt,wn,res);

% -------------------------------------------------------------------------
function [p_value Idiff p_value2 Idiff2 p_value3 Idiff3 p_value4 Idiff4] = ...
    isikldist(spt,dt,win,res)
