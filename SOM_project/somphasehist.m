function somphasehist(cellids)
%SOMPHASEHIST   Phase histogram.
%   SOMPHASEHIST calculates theta phase histogram. Stimulation segments are
...
%   SD are discarded.
%
%   SOMPHASEHIST(I) uses cells defined by the index set I.
%   SOMPHASEHIST(CELLIDS) uses cells defined by the list of CellIDs
%   (CELLIDS).
%
%   See also SOMSTA, SOMSFCOH and PHASEHIST.
...
global DATAPATH
fs = filesep;
resdir = [DATAPATH 'SOM' fs 'phasehist' fs];  % results directory
